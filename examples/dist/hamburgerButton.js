...
var HamburgerButton = function () {
  function HamburgerButton(container, size, color) {
    classCallCheck(this, HamburgerButton);
  ...
  HamburgerButton.prototype.toggle = function toggle() {
  ...
  HamburgerButton.prototype.onSpringUpdate = function onSpringUpdate(spring) {
    this.render();
  };
  ...
  HamburgerButton.prototype.drawBar = function drawBar(width) {
  ...
  HamburgerButton.prototype.render = function render() {
    ...
    var xlatY = mapVal(val, 0, 1, this.height - this.barHeight, this.height - this.rotatedXlat);
    rot = mapVal(val, 0, 1, 0, -45);
    width = mapVal(val, 0, 1, this.width, this.rotatedWidth);
